...
Nota: A versão da ROM de controle do pipeline nestes arquivos CONTÉM a instrução J.

Eu botei tudo o que cada processador precisa nas suas respectivas pastas, não só os arquivos de memória.
